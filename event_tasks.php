            ...
            <body>
                ...
                <div id="corps">
                    ...
                    <form method="post" action="post_crud_event.php" id="create_event">
                        ...
                        <input type="date" name="begin_date" required=""<?php echo 'value="'.date('Y-m-d', strtotime($event['begin_time_event'])).'"' ?>>
                        <input type="time" name="begin_time" required=""<?php echo 'value="'.date('H:i', strtotime($event['begin_time_event'])).'"' ?>><br>
                        Date et heure de fin:<br>
                        <input type="date" name="end_date" required=""<?php echo 'value="'.date('Y-m-d', strtotime($event['end_time_event'])).'"' ?>>
                        <input type="time" name="end_time" required=""<?php echo 'value="'.date('H:i', strtotime($event['end_time_event'])).'"' ?>><br> -->
